  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-ledger-50 px-4 py-10">
      <div className="w-full max-w-2xl rounded-[2rem] border border-ledger-200 bg-white p-10 text-center shadow-ledger">
        <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-3xl bg-danger-50 text-danger-600">
          <AlertCircle size={28} />
        </div>
        <h1 className="text-4xl font-bold text-ledger-900">Route error</h1>
        <p className="mt-3 text-sm text-ledger-500">
          Something went wrong while rendering this route. Please return to the dashboard or try again.
        </p>
        <Link
